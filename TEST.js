        ...
        var o = r(11),
            n.push([e.i, 
                ...
                .form - wrap.form - builder.formbuilder - autocomplete - list li {
                    ...
                    padding: 5 px;
                    margin: 0;
                    transition: background - color 200 ms ease - in -out;
                }
...
@media(max - width: 481px) {
    ...
    background: # fff; -
                    ...
                    overflow: hidden;
                    box - shadow: inset 0 0 0 1 px #c5c5c5
                }
                ...
                .form - wrap.form - builder.frmb - control li.ui - sortable - helper {
                    border - radius: 5 px;
                    transition: box - shadow 250 ms;
                    box - shadow: 2 px 2 px 6 px 0 #666;
...
@media(max - width: 481px) {
    ...
    border: 3px dashed # ccc; background - color: rgba(255, 255, 255, 0.25)
                        }
                        ...
                        .form - wrap.form - builder.frmb {
                            ...
                            min - height: 200 px;
                            transition: background - color 500 ms ease - in -out
                        }
    ...
    box - shadow: 2px 2px 6px 0 # 666; border: 1 px solid #fff; border - radius: 5 px
                                }
    ...
    color:# 666;
                                    ...
                                    bottom: 6 px;
                                    background: #fff;
                                    border - top: 1 px solid #c5c5c5;
                                    border - left: 1 px solid #c5c5c5;
                                    border - right: 1 px solid #c5c5c5;
                                    transform: translateX(-50 % );
                                    padding: 0 5 px;
                                    border - top - right - radius: 3 px;
                                    border - top - left - radius: 3 px;
                                    cursor: pointer;
                                    transition: background - color 250 ms ease - in -out
                                }
    ...
    box - shadow: 0 0 0 1px # fff inset;
                            ...
                            .form - wrap.form - builder.frmb.form - elements select {
                                transition: background 250 ms ease - in -out;
                                padding: 6 px 12 px;
                                border: 1 px solid #c5c5c5;
                                background - color: #fff
                            }
                            ...
                            .form - wrap.form - builder.frmb.form - elements.available - roles {
                                ...
                                margin: 10 px 0;
                                background: #e6e6e6;
                                box - shadow: inset 0 0 2 px 0 #b3b3b3
                            }
                            @media(max - width: 481 px) {
                                .form - wrap.form - builder.frmb.form - elements.available - roles {
                                    margin - left: 0
                            ...
                            .form - wrap.form - builder * [tooltip]: hover: after {
                                    ...
                                    border - radius: 5 px 5 px 5 px 0;
                                    bottom: 23 px;
                                    color: #fff;
    ...
    border - color:# 666 transparent;
                            ...
                            .formbuilder - mobile.frmb li.del - button,
                            .formbuilder - mobile.frmb li.toggle - form {
                                opacity: 1
                            }
    ...
    background - color:# 23241 f;
                                ...
                                .form - builder - dialog.positioned.button - wrap::before {
                                    ...
                                    width: 0;
                                    height: 0;
                                    border - left: 15 px solid transparent;
                                    border - right: 15 px solid transparent;
                                    border - top: 10 px solid #fff;
                                    position: absolute;
                                    left: 50 % ;
                                    top: 100 % ;
            ...
            const { multiple: r, options: o, label: i, value: l, class: a, className: s } = t, u = x(t, ["multiple", "options", "label", "value", "class", "className"]), f = Object.keys(o).map(e => { const t = { value: e }, r = o[e], n = Array.isArray(r) ? d.a.get(...r) || r[0] : r; return (Array.isArray(l) ? l.includes(e) : e === l) && (t.selected = null), O("option", n, t) }), p = {
                id: `
                    $ {
                        e
                    } - $ {
